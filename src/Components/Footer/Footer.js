  ...
  return (
    ...
    <div className='web'>
        <div className='containerOneF'>
            ...
            <Link to="/"  onClick={scrollToTop} style={{ textDecoration:'none' }}><h3 className='listItemsOne'>Terms of Use</h3></Link>
            <Link to="/"  onClick={scrollToTop} style={{ textDecoration:'none' }}><h3 className='listItemsOne'>Warranty</h3></Link>
            <Link to="/"  onClick={scrollToTop} style={{ textDecoration:'none' }}><h3 className='listItemsOne'>Privacy Policy</h3></Link>
            </div>
        </div>
        ...
        <div className='containerThreeF'>
            <h1>Follow Us</h1>
            <a href='callto:0380682026' style={{ textDecoration:'none',color:'white' }}><p className='containerThreePF'>011-2043 2729</p></a>
    ...
    <div className='mobile'>
        <div className='containerOneF'>
            <h1>Quick Links</h1>
            <Link className='listItemsOne' to='/'>Home</Link>
            <br/>
            <Link className='listItemsTwo' to='/about'>About Us</Link>
            <br/>
            <Link className='listItemsThree' to='/product'>Products</Link>
            <br/>
            <Link className='listItemsFour'to='/blog'>Blog</Link>
            <br/>
            <Link className='listItemsFive' to='/support'>Support</Link>
            <br/>
            <Link className='listItemsSix' to='/'>Terms of Use</Link>
            <br/>
            <Link className='listItemsSeven' to='/'>Warranty</Link>
            <br/>
            <Link className='listItemsEight' to='/'>Privacy Policy</Link>
        </div>
